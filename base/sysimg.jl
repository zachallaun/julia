...
compile_hint(getindex, (Dict{Any,Any}, Int32))
...
compile_hint(Set, ())
compile_hint(setindex!, (Dict{Any,Any}, Bool, Cmd))
...
compile_hint(setindex!, (Array{Any,1}, WeakRef, Int))
compile_hint(setindex!, (Dict{Any,Any}, WorkItem, (Int,Int)))
...
compile_hint(getindex, (Type{ByteString}, ASCIIString, ASCIIString, ASCIIString, ASCIIString, ASCIIString, ASCIIString))
...
compile_hint(getindex, (BitArray{1}, Int,))
compile_hint(setindex!, (BitArray{1}, Bool, Int,))
...
compile_hint(setindex!, (Vector{Uint8}, Uint8, Int))
